...
let app = new Vue({
    el: '#root',
    data: {
        titoliImmagini: ['Drago con donna elfo alata', 'Drago Ala blu', 'Drago Verde'],
        indice: 0,
        srcImages: ['https://lh3.googleusercontent.com/proxy/-fS-ioXefF4czZj_Xf0sTzIxQ9dCU9NP2e6bFlfxPm5DaCE1QMQsM67zJZ41ArrJNJfiSYiQrWzxw9c1pdvG1TVHJ0vvo1Gb7uxi-PeR',
    ...
    methods: {
        nextIndex: function(){
            this.indice = (this.indice + 1) % this.srcImages.length;
        }
    }
